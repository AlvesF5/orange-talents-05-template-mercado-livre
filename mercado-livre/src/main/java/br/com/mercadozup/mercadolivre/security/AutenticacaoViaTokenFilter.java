...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
	...
	public AutenticacaoViaTokenFilter(GerenciadorDeToken gerenciadorToken,  UsuarioRepository usuarioRepository) {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		boolean valido = gerenciadorToken.isTokenValido(token);
	...
	private void autenticarCliente(String token) {
		...
		Long idUsuario = gerenciadorToken.getIdUsuario(token);
